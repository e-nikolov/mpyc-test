...
var CHANNEL = '2f6fe6d4-8ba8-424a-83c5-8fadca1ea103';
...
var thread = (main, MAIN, THREAD) => {
  ...
  const remoteArray = window.Array[isArray$1];
...
const writeFile$1 = ({ FS, PATH, PATH_FS }, path, buffer) => {
...
// REQUIRES INTEGRATION TEST
/* c8 ignore start */
function registerJSModule$1(interpreter, _, value) {
...
const writeFile = ({ FS, PATH, _module: { PATH_FS: PATH_FS } }, path, buffer) => {
    writeFile$1({ FS, PATH, PATH_FS }, path, buffer);
};
...
var ruby_wasm_wasi = {
    ...
    registerJSModule: registerJSModule$1,
...
export { XWorker, define, whenDefined };
