...
export function init(mpyc: MPyCManager) {
    ...
    ui.resetPeerIDButton.addEventListener('click', () => { delete sessionStorage.myPeerID; console.log('resetPeerID'); ui.term.writeln("Restarting PeerJS..."); mpyc.resetPeer(""); });
    ui.stopMPyCButton.addEventListener('click', () => { console.log('Restarting PyScript runtime...'); ui.term.writeln("Restarting PyScript runtime..."); mpyc.resetWorker(); });
    ...
    if (sessionStorage.myPeerID) {
        //ui.myPeerIDEl.value = sessionStorage.myPeerID;
    }
